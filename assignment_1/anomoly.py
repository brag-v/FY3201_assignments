...
plt.plot(x, data['Annual_Anomaly'], label='Annual Anomaly')
plt.fill_between(x, data['Annual_Unc'] + data['Annual_Anomaly'], data['Annual_Anomaly'] - data['Annual_Unc'], alpha=0.5, label='Annual Uncertainty (95% CI)')
